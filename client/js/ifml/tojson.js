...
exports.toJSON = function (graph) {
    ...
    var relations = createTransformer({
            element: extractRelationsRules
        }, core.flatten())({elements: graph.getCells()}),
        elements = createTransformer({
            element: extractElementsRules
        }, core.reduceBy('id', core.merge(core.last(), {
            attributes: core.merge(),
            metadata: core.merge(core.last(), {graphics: core.merge()})
